...
#ifndef FLUKAVIKE_SWIFT_H
#define FLUKAVIKE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flukavike",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9flukavike11AppDelegate")
...
SWIFT_CLASS("_TtC9flukavike18AudioPlayerService")
@interface AudioPlayerService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioPlayer;
@interface AudioPlayerService (SWIFT_EXTENSION(flukavike)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end

SWIFT_CLASS("_TtC9flukavike20AudioRecorderService")
@interface AudioRecorderService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface AudioRecorderService (SWIFT_EXTENSION(flukavike)) <AVAudioRecorderDelegate>
- (void)audioRecorderDidFinishRecording:(AVAudioRecorder * _Nonnull)recorder successfully:(BOOL)flag;
@end

SWIFT_CLASS("_TtC9flukavike20FlukavikeCallService")
@interface FlukavikeCallService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface FlukavikeCallService (SWIFT_EXTENSION(flukavike)) <CXProviderDelegate>
...
SWIFT_CLASS("_TtC9flukavike22JoinVoiceChannelIntent") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface JoinVoiceChannelIntent : INIntent
...
SWIFT_CLASS("_TtC9flukavike30JoinVoiceChannelIntentResponse") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface JoinVoiceChannelIntentResponse : INIntentResponse
...
SWIFT_CLASS("_TtC9flukavike23PushNotificationService")
@interface PushNotificationService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface PushNotificationService (SWIFT_EXTENSION(flukavike)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler;
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
...
SWIFT_CLASS("_TtC9flukavike16WebSocketService")
...
@interface WebSocketService (SWIFT_EXTENSION(flukavike)) <NSURLSessionWebSocketDelegate>
